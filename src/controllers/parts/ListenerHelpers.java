...
public class ListenerHelpers {
   ...
   *
   * @param field ChoiceBox to add listener to
   * @param measurement measurement to set
   */
   ...
   *
   * @param field TextField to add listner to
   * @param measurement measurement to set
   */
   ...
   *
   * @param field TextField to add listener to
   * @param measurement measurement to set
   */
